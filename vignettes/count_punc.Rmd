...
The `count_punc` function from the `textfeatureinfo` package is one of four functions that aids in this text data extraction process. Specifically, `count_punc` makes it easy to extract the number of punctuation inside a piece of text.
